...
enum PlayingStatus { playing, paused, stoped }
              ...
              itemBuilder: (context, index) {
                return Card(
                  child: ListTile(
                    ...
                    onTap: () async {
                      int result = await audioPlayer.play(files[index].path,
                          isLocal: true);
                      print(result);
...
// /storage/emulated/0/Download/Silence Love Mashup Debb Chillout Mashup 2020 Baarish Dil Ko Maine Di Kasam Aidc.mp3
